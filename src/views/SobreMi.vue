...
<template>
    <v-app>
                    ...
                    <v-row align="center" justify="center" class="fill-height">
                        <v-col cols="12" class="text-center">
                            ...
                            <h1 class="text-h3 font-weight-bold text-white mb-4">
                                Bienvenidos a DG Studio Academy Cosmetología Online
                            </h1>
                                    ...
                                    <v-row justify="center">
                                        <v-col cols="12" xl="10" lg="10" md="12">
                                            <div class="text-center mb-8">
                                                <img src="/public/youtuber.svg" alt="Icono Cosmetología" class="section-icon">
                                                <h2 class="text-h3 font-weight-bold text-primary mb-4">
                                                    Tu Aliada en el Mundo de la Cosmetología
                                                </h2>
                                                <v-divider class="my-4" color="primary" thickness="2" width="100"></v-divider>
                                            </div>
                                                ...
                                                <v-row align="center" class="h-100">
                                                    <v-col cols="12" lg="6" md="6">
                                                        <v-img 
                                                            ...
                                                            height="400"
                                                            cover 
                                                            class="rounded-lg platform-image"
                                                        ></v-img>
                                                    </v-col>
                                                    <v-col cols="12" lg="6" md="6">
                                                        ...
                                                        <p class="text-body-1 mb-6 platform-description">
                                                            Studio Academy es una plataforma diseñada específicamente para
                                                            <strong class="highlight-text">apoyar a cosmetólogas</strong> en todos los aspectos de su práctica
                                                            profesional.
                                                        </p>
                                                        ...
                                                        <v-list class="transparent platform-list">
                                                            ...
                                                            <v-list-item class="platform-list-item">
                                                                ...
                                                                <v-list-item-title class="font-weight-medium text-body-1">
                                                                    Experiencia personal como cosmetóloga y micropigmentadora
                                                                </v-list-item-title>
                                                            </v-list-item>
                                                        </v-list>
                                                    </v-col>
                                            ...
                                            <v-row class="mt-8" justify="center">
                                                <v-col cols="12" md="4" class="text-center">
                                                    <v-card class="pa-4 info-card" elevation="2" height="100%">
                                                        <v-icon icon="mdi-certificate" size="48" color="primary" class="mb-3"></v-icon>
                                                        <h4 class="text-h6 font-weight-bold text-secondary mb-3">
                                                            Certificación Profesional
                                                        </h4>
                                                        <p class="text-body-2">
                                                            Contenido avalado por años de experiencia en el sector de la cosmetología
                                                        </p>
                                                    </v-card>
                                                </v-col>
                                                <v-col cols="12" md="4" class="text-center">
                                                    <v-card class="pa-4 info-card" elevation="2" height="100%">
                                                        <v-icon icon="mdi-update" size="48" color="primary" class="mb-3"></v-icon>
                                                        <h4 class="text-h6 font-weight-bold text-secondary mb-3">
                                                            Actualización Constante
                                                        </h4>
                                                        <p class="text-body-2">
                                                            Protocolos y técnicas siempre actualizadas según las últimas tendencias
                                                        </p>
                                                    </v-card>
                                                </v-col>
                                                <v-col cols="12" md="4" class="text-center">
                                                    <v-card class="pa-4 info-card" elevation="2" height="100%">
                                                        ...
                                                        <p class="text-body-2">
                                                            Forma parte de una red de cosmetólogas profesionales en crecimiento
                                                        </p>
                                                    </v-card>
                                                </v-col>
                                            </v-row>
        ...
        <v-footer class="text-center d-flex flex-column ga-2 py-8" color="primary">
            ...
            <div class="text-body-2 font-weight-regular text-white px-4 mb-4" style="max-width: 800px; line-height: 1.6;">
